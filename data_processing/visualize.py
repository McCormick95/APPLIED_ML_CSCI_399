...
def create_visualization(input_dir, output_dir):
    ...
    try:
        # Create static plot of final state
        ...
        fig.savefig(output_dir / 'final_state_analysis.png', dpi=300, bbox_inches='tight')
        plt.close(fig)
        ...
        anim.save(output_dir / 'state_evolution.mp4', writer='ffmpeg')
        plt.close(fig)
